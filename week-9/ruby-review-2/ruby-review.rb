...
# create car class
# create player class
# have player class inherit from car class
# in car class, initialize with model and color
#  write disance, total_distance, speed, brake, accelerate, decelerate, navigate, current_direction methods
# player class now has access to these methods and can make a new car object within player class, choose model and color.
# write loop to go through console print outs of choices in the game and depending on users input, display what's happening, keep track of changes.
...
# What concepts did you review in this challenge?
  ...
  # I reviewed class construction, initializing a method, inheritence, defining methods, as well as constructing a program that is used to work in the console. So much fun!

# What is still confusing to you about Ruby?

  # Really just syntax and best practices for iteration

# What are you going to study to get more prepared for Phase 1?

  # Ruby best practices, writing small programs, making sure I'm sound on both Ruby and JavaScript syntax.