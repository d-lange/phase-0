...
//What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  ...
  // adding the name values into the name of the specific name property. I initiated it as empty first so that i could then implement the .name property.

//How difficult was it to add and delete properties outside of the object itself?

  // I didn't find it that hard. Once I got the hang of it, it was fairly simple.

//What did you learn about manipulating objects in this challenge?

  // It's simple to access inside the data and modify it, but when adding specific information, it's important to remember to create room for a value to be set.
